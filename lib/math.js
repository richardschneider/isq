...
/*
 * Force a class to be an SI Number.  In particular define prototype methods
 * for the standard named mathematical operators.
 */
...
const operators = [
    ...
    { symbol: '>=', methods: ['gte', 'greaterThanOrEqual',],
      fallback: function(other) { return this.cmp(other) >= 0; } },
    { methods: ['toNumber'], fallback: function() { return Number(this.valueOf()); } },
];
